...
function inicio(){
   ...
   var controlador = base_url+'pedido/vaciar_adetalle';
           ...
           success:function(respuesta){     
               ...
               if (registros != null){
                    ...
                    for (var i = 0; i < x ; i++){
                        ...
                        html += "                           <small><br>"+categoria+registros[i]["producto_unidad"]+" | "+registros[i]["producto_codigobarra"]+"</small>";
...
{
    var base_url = document.getElementById('base_url').value;
    var controlador = base_url+"pedido/modificar_pedido";    
    ...
    var pedido_fecha = moment(hora).format('YYYY-MM-DD HH:mm:ss');//retorna la fecha actual  //"date(now())";
...
//alert(pedido_fecha);
    var cad = usuario_id+","+estado_id+","+cliente_id+","+tipotrans_id+","+pedido_fecha2+","+
        ...
        $.ajax({
            url: controlador,
            type:"POST",
            data:{tipo_trans:tipo_trans, cuotas:cuotas, cuota_inicial:cuota_inicial,tipotrans_id:tipotrans_id,pedido_fechaentrega:pedido_fechaentrega, 
                pedido_total:pedido_total, credito_interes:credito_interes, pedido_id:pedido_id,pedido_glosa:pedido_glosa,pedido_horaentrega:pedido_horaentrega,
                ...
                pedido_latitud:pedido_latitud,pedido_longitud:pedido_longitud,regusuario_id:regusuario_id},
            success:function(respuesta){ 

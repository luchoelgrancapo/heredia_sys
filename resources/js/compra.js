               ...
               if (registros != null){
                   ...
                   if (n <= limite) x = n; 
                     ...
                     for (var i = 0; i < x ; i++){
                        ...
                        html += "<td>"+(i+1)+"</td>";
                        html += "<td><b>"+registros[i]["proveedor_nombre"]+"</b><font size='1'>["+registros[i]["proveedor_id"]+"]<br>";
                        if (registros[i]["tipotrans_nombre"]=='CREDITO') {
                        html += "<span class='badge badge-secundary'>"+registros[i]["tipotrans_nombre"]+"</span></br>";
                        } else {

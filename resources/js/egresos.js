...
//                        html += "<a href='"+base_url+"egreso/boucher/"+registros[i]["egreso_id"]+"' title='BOUCHER' target='_blank' class='btn btn-facebook btn-xs'><span class='fa fa-print'></a>";
                        html += "<td class='no-print'><a href='"+base_url+"egreso/imprimir/"+registros[i]["egreso_id"]+"' title='Imprimir comprobante' target='_blank' class='btn btn-success btn-xs'><span class='fa fa-print'></a>";

                        html += " <a href='"+base_url+"egreso/edit/"+registros[i]["egreso_id"]+"'  class='btn btn-info btn-xs'><span class='fas fa-edit'></a>";
                        html += " <a class='btn bg-danger btn-xs' data-toggle='modal' data-target='#myModal"+i+"' title='Eliminar'><span class='fa fa-trash'></span></a>";
                        html += "<!------------------------ INICIO modal para confirmar eliminacion ------------------->";

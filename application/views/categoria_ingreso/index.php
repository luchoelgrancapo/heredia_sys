...
<div class="col-md-6">
  <div class="box-header">
               <h4><b>INGRESOS</b> <small class="badge badge-secondary" id="pillados"><?php echo sizeof($categoria_ingreso); ?></small></h4>
  </div>
</div>   
<div class="col-md-6">   
    <div class="box-tools no-print">
        <a href="<?php echo site_url('categoria_ingreso/add'); ?>" class="btn bg-success btn-app"><fa class='far fa-save'></fa> Registrar</a> 
    </div>
</div>
</div>
<div class="row">
                ...
                <table class="table table-striped table-condensed" id="mitabla">
                    ...
                    <tr>
                        ...
                        <!------------------------ FIN modal para confirmar eliminación ------------------->
                            <a href="<?php echo site_url('categoria_ingreso/edit/'.$c['id_cating']); ?>" class="btn btn-info btn-xs"><span class="fa fa-edit"></span></a> 

...
<script src="<?php echo base_url('resources/js/funciones_pedidomodif.js'); ?>"></script>
...
<input type="text" id="pedido_id" value="<?php echo $pedido_id ?>" name="pedido_id"  hidden>
...
<center>
    ...
    <button onclick="focus_cliente()" id="boton_bsucar_clie" data-toggle="modal" data-target="#modalbuscar" class="btn bg-primary btn-app" ><span class="fa fa-search"></span> Buscar Clie</button>
     ...
     <!--<a href="<?php echo base_url("cliente/clientenuevo/".$pedido_id); ?>" class="btn bg-success btn-app" ><span class="fa fa-user" ></span> Nuevo</a>-->

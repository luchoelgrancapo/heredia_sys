        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <!-- sidebar: style can be found in sidebar.less -->
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo site_url('reserva');?>" class="nav-link">
                                <i class="nav-icon fas fa-calendar-check fa-fw"></i> <p>Reservas</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo site_url('acceso');?>" class="nav-link">
                                <i class="nav-icon fas fa-user-shield  fa-fw"></i> <p>Control de acceso</p>
                            </a>
                        </li>
                        <li class="nav-item">
          ...
          <li class="nav-item has-treeview">
            ...
            <footer class="main-footer no-print">
                <strong>Generated By <a target="_blank" href="https://hvsistemasysoluciones.com/">HV Sistemas y Soluciones</a></strong>
            </footer>

    ...
    <div class="col-md-12">
      	<div class="card card-secondary">
            <div class="card-header with-border">
              	<h3 class="box-title">Añadir Sección</h3>
            </div>
            <?php echo form_open('seccion/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="seccion_tipo" class="form-control">
								...
								{
									$selected = ($value == $this->input->post('seccion_tipo')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="seccion_titulo" value="<?php echo $this->input->post('seccion_titulo'); ?>" class="form-control" id="seccion_titulo" required />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="seccion_descripcion" value="<?php echo $this->input->post('seccion_descripcion'); ?>" class="form-control" id="seccion_descripcion" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="seccion_texto" class="control-label">Texto</label>
						<div class="form-group">
							<textarea name="seccion_texto" class="form-control" id="seccion_texto"><?php echo $this->input->post('seccion_texto'); ?></textarea>
						</div>
					</div>
				</div>
			</div>

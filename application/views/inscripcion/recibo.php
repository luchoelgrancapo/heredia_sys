    ...
    <tr>
        <td colspan="3">
            ...
            <center>
                ...
                <font size="2" face="arial"><b>Nº:  00<?php echo $inscripcion['inscripcion_id']; ?> </b></font> <br>            
    ...
    <tr style="border-top-style: solid; border-top-width: 2px; border-bottom-style: solid; border-bottom-width: 2px;"> 
        <td colspan="3">           
            <center>                      
                ...
                <?php $fecha = new DateTime($inscripcion['inscripcion_fecha']); 
                 $fechaini = new DateTime($inscripcion['inscripcion_fechaini']); 
                 $fechafin = new DateTime($inscripcion['inscripcion_fechafin']); 
                        $fecha_d_m_a = $fecha->format('d/m/Y');
                  ?>    
                    <b>LUGAR Y FECHA: </b><?php echo $empresa[0]['empresa_departamento'].", ".$fecha_d_m_a; ?> <br>                  
                    <b>RECIBI DE: </b><?php echo $inscripcion['cliente_nombre'].""; ?>
...
<!--</table>
       ...
       <table class="table"  style="width: 7cm; margin: 0; padding: 0;" >-->
           <tr>
               ...
               <td align="right" colspan="2">
                    ...
                    <b>
                        <?php echo number_format($inscripcion['inscripcion_monto'],2,'.',','); ?>
                    </b>
                    </font>
               </td>
           ...
           <tr>
               ...
               <td colspan="2">INSCRIPCION PLAN <?php echo $inscripcion['serviciote_nombre'];?>(<?php echo $inscripcion['serviciote_duracion'];?> MESES)<br></td>
                
               
           </tr>
           <tr>
               <td align="left"><b>PERIODO: </b></td>
               <td align="left"><b>INICIO: </b><?php echo date_format($fechaini, 'd/m/Y');?> - <b>FIN: </b><?php echo date_format($fechafin, 'd/m/Y');?></td>
    ...
    <tr  style="border-top-style: solid; border-top-width: 2px; border-bottom-style: solid; border-bottom-width: 2px;">
        ...
        <td align="right" colspan="3">
            ...
            <font size="2">
            <b>
                <?php echo "TOTAL FINAL Bs: ".number_format($inscripcion['inscripcion_monto'] ,2,'.',','); ?><br>
            </b>
            </font>
            <font size="1" face="arial narrow">
                <?php echo "SON: ".num_to_letras($inscripcion['inscripcion_monto'],' Bolivianos'); ?>           
            </font>
    ...
    <tr >
        <td colspan="3">
               ...
               USUARIO: <b><?php echo $inscripcion['usuario_nombre']; ?></b>

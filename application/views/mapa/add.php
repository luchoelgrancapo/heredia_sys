    ...
    <div class="col-md-12">
      	<div class="card card-secondary">
            <div class="card-header with-border">
              	<h3 class="box-title">Añadir Mapa</h3>
            </div>
            <?php echo form_open('mapa/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="mapa_titulo" value="<?php echo $this->input->post('mapa_titulo'); ?>" class="form-control" id="mapa_titulo" required />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="mapa_descripcion" value="<?php echo $this->input->post('mapa_descripcion'); ?>" class="form-control" id="mapa_descripcion" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="mapa_latitud" class="control-label">Latitud</label>
						<div class="form-group">
							<input type="number" name="mapa_latitud" value="<?php echo $this->input->post('mapa_latitud'); ?>" class="form-control" id="mapa_latitud" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="mapa_longitud" class="control-label">Longitud</label>
						<div class="form-group">
							<input type="number" name="mapa_longitud" value="<?php echo $this->input->post('mapa_longitud'); ?>" class="form-control" id="mapa_longitud" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="mapa_indicador" class="control-label">Indicador</label>
						<div class="form-group">
							<input type="text" name="mapa_indicador" value="<?php echo $this->input->post('mapa_indicador'); ?>" class="form-control" id="mapa_indicador" />
						</div>
					</div>
				</div>
			</div>
